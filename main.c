...
int main()
{
    ...
    if ((arq = fopen ("Tabela.txt","r"))==NULL){
        ...
        if(!(strcmp(op,"busca elemento"))){
            ...
            int NumAtomos = 0.0;
            int selec = 0, i = 0;
            float Nmol = 0; // Número de mols
            float NumG = 0.0, ResultNm = 0.0, guarda = 0.0, MassaG = 0.0, /* Massa em gramas*/ Massaatomica =0.0, Massamolar = 0.0; //Multiplicar a quantidade de átomos do elemento pela massa atomica
            float ResultFinal = 0.0, ResultMassaG = 0.0; // Resultado da massa



            printf("\                   Conversão mol/ grama e grama/mol:\n\n");
            printf("1- Para conversão grama/ mol de um elemento:\n");
            printf("2- Para conversão grama/ mol de uma substância:\n");
            printf("3- Para conversão mol/grama de um elemento:\n");
            printf("4- Para conversão mol/grama de uma substância:\n");
            scanf("%d", &selec);
            getchar();
            ...
            switch (selec){
                ...
                case 4:
                    ...
                    printf("Informe o Numero de Mol:\n");
                    scanf("%f", &Nmol);
                    printf("Informe o numero de elementos da substância:\n");
                    scanf("%d", &substancia);
                    getchar();
            ...
            printf("informe os dois elementos no estado reduzido que serão utilizados para criar a pilha \nseparados por um espaço: (Zn [enter] Cu[enter])\n");
            scanf("%[^\n]s", &elem1);
            getchar();
            strcat(elem1, "\n");
